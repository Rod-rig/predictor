...
describe('RegistrationStore', () => {
  ...
  it('should change fields', () => {
    const changeSpy = jest.fn(registrationStore.handleChange.bind(registrationStore));
  ...
  it('should submit form', () => {
    ...
    const submitSpy = jest.fn(registrationStore.handleSubmit.bind(registrationStore));
