...
export const logos: ILogo = {
    ...
    'AC Chievo Verona': 'https://upload.wikimedia.org/wikipedia/en/4/4a/Chievo-verona-teamName.png',
    ...
    'Sint-Truidense VV': 'https://upload.wikimedia.org/wikipedia/en/f/f1/K._Sint-Truidense_V.V._logo.png',
