...
export const logos: ILogo = {
  ...
  "SD Eibar":
    "https://upload.wikimedia.org/wikipedia/en/3/3b/SD_Eibar_logo_2016.svg",
  "Real Valladolid":
  ...
  "Villarreal CF":
    "https://upload.wikimedia.org/wikipedia/en/7/70/Villarreal_CF_logo.svg",
  "Athletic Bilbao":
  ...
  "LOSC Lille":
    "https://upload.wikimedia.org/wikipedia/en/3/3f/Lille_OSC_2018_logo.svg",
  "Montpellier HSC":
    "https://upload.wikimedia.org/wikipedia/en/a/a8/Montpellier_HSC_logo.svg",
  "Olympique Lyonnais":
  ...
  "AS Saint-Etienne":
    "https://upload.wikimedia.org/wikipedia/commons/2/2c/Logo_AS_Saint-%C3%89tienne.svg",
  "OGC Nice":
    "https://upload.wikimedia.org/wikipedia/en/2/2e/OGC_Nice_logo.svg",
  "Olympique Nimes":
    "https://upload.wikimedia.org/wikipedia/en/0/05/N%C3%AEmes_Olympique_2018_logo.svg",
  "RC Strasbourg Alsace":
    "https://upload.wikimedia.org/wikipedia/en/8/80/Racing_Club_de_Strasbourg_logo.svg",
  ...
  "EA Guingamp":
    "https://upload.wikimedia.org/wikipedia/en/5/56/En_Avant_Guingamp_logo.svg",
  "FC Metz": "https://upload.wikimedia.org/wikipedia/en/7/71/FC_Metz_logo.svg",
  "Stade Brestois 29":
    "https://upload.wikimedia.org/wikipedia/en/0/05/Stade_Brestois_29_logo.svg",
  "FC Lorient":
    "https://upload.wikimedia.org/wikipedia/en/4/4c/FC_Lorient_logo.svg",
  ...
  "Genoa CFC": "https://upload.wikimedia.org/wikipedia/en/4/4e/Genoa_cfc.png",
  Spal: "https://upload.wikimedia.org/wikipedia/en/3/3c/Spal2013_logo.svg",
  "Udinese Calcio":
  ...
  "Brescia Calcio":
    "https://upload.wikimedia.org/wikipedia/en/1/17/Brescia_calcio_badge.svg",
  ...
  "Feyenoord Rotterdam":
    "https://upload.wikimedia.org/wikipedia/en/e/e3/Feyenoord_logo.svg",
  "Heracles Almelo":
    "https://upload.wikimedia.org/wikipedia/en/9/9e/Heracles_Almelo_logo.svg",
  "FC Utrecht":
    "https://upload.wikimedia.org/wikipedia/commons/9/92/FC_Utrecht.png",
  "Vitesse Arnhem":
    "https://upload.wikimedia.org/wikipedia/en/9/93/Vitesse_logo.svg",
  "AZ Alkmaar":
    "https://upload.wikimedia.org/wikipedia/commons/e/e0/AZ_Alkmaar.svg",
  "SC Heerenveen":
    "https://upload.wikimedia.org/wikipedia/en/e/e1/SC_Heerenveen_logo.svg",
  "VVV Venlo":
    "https://upload.wikimedia.org/wikipedia/en/6/60/VVV-Venlo_logo.svg",
  "Fortuna Sittard":
    "https://upload.wikimedia.org/wikipedia/en/2/2d/Fortuna_Sittard_logo.svg",
  "Willem II Tilburg":
    "https://upload.wikimedia.org/wikipedia/en/7/77/Willem_II_logo.svg",
  "ADO Den Haag":
    "https://upload.wikimedia.org/wikipedia/en/a/ad/ADO_Den_Haag_logo.svg",
  "SBV Excelsior":
    "https://upload.wikimedia.org/wikipedia/en/f/f5/SBV_Excelsior_logo.png",
  "PEC Zwolle":
    "https://upload.wikimedia.org/wikipedia/en/f/f3/PEC_Zwolle_logo.svg",
  "FC Emmen":
    "https://upload.wikimedia.org/wikipedia/en/8/83/FC_Emmen_logo.svg",
  "FC Groningen":
    "https://upload.wikimedia.org/wikipedia/en/2/2c/FC_Groningen_logo.svg",
  "De Graafschap":
    "https://upload.wikimedia.org/wikipedia/commons/2/28/VBV_De_Graafschap_Doetinchem.svg",
  "NAC Breda":
    "https://upload.wikimedia.org/wikipedia/commons/c/c9/Logo_NAC_Breda.png",
  "FC Twente Enschede":
    "https://upload.wikimedia.org/wikipedia/en/e/e3/FC_Twente.svg",
  "RKC Waalwijk":
    "https://upload.wikimedia.org/wikipedia/en/6/67/RKC_Waalwijk_logo.svg",
  "Sparta Rotterdam":
    "https://upload.wikimedia.org/wikipedia/en/9/9f/Sparta_Rotterdam_logo.svg",
  "Istanbul Basaksehir FK":
    "https://upload.wikimedia.org/wikipedia/en/e/e1/%C4%B0stanbul_Ba%C5%9Fak%C5%9Fehir_logo.svg",
  Kasimpasa:
    "https://upload.wikimedia.org/wikipedia/en/1/18/Kasimpasa_logo.svg",
  "Besiktas JK":
  ...
  "Yeni Malatyaspor":
    "https://upload.wikimedia.org/wikipedia/en/5/5e/Yeni_Malatyaspor_logo.svg",
  Trabzonspor:
    "https://upload.wikimedia.org/wikipedia/en/c/c7/Trabzonspor_logo.svg",
  "Atiker Konyaspor 1922":
    "https://upload.wikimedia.org/wikipedia/en/d/d1/Konyaspor_logo.svg",
  "MKE Ankaragucu":
    "https://upload.wikimedia.org/wikipedia/en/3/3a/Ankaragucu_logo.svg",
  Bursaspor: "https://upload.wikimedia.org/wikipedia/en/0/01/Bursaspor.png",
  "Goztepe SK":
    "https://upload.wikimedia.org/wikipedia/en/2/2d/G%C3%B6ztepe_logo.svg",
  Sivasspor:
    "https://upload.wikimedia.org/wikipedia/en/2/20/Sivasspor_logo.svg",
  Alanyaspor:
    "https://upload.wikimedia.org/wikipedia/en/4/40/Alanyaspor_logo.svg",
  "Buyuksehir Belediye Erzurumspor":
    "https://upload.wikimedia.org/wikipedia/en/2/26/" +
    "B%C3%BCy%C3%BCk%C5%9Fehir_Belediye_Erzurumspor_logo.png",
  Fenerbahce:
    "https://upload.wikimedia.org/wikipedia/en/3/39/Fenerbah%C3%A7e.svg",
  "Akhisar Bld Spor":
    "https://upload.wikimedia.org/wikipedia/en/c/c2/Akhisar_Belediye_Logo.png",
  Kayserispor:
    "https://upload.wikimedia.org/wikipedia/en/f/f4/Kayserispor_logo.svg",
  "Caykur Rizespor":
    "https://upload.wikimedia.org/wikipedia/en/5/5f/Caykur_Rizespor_logo.svg",
  Denizlispor:
    "https://upload.wikimedia.org/wikipedia/en/0/05/Denizlispor_logo.svg",
  "Gaziantep FK":
  ...
  "RSC Anderlecht":
    "https://upload.wikimedia.org/wikipedia/en/7/71/RSC_Anderlecht_logo.svg",
  "Standard Liege":
    "https://upload.wikimedia.org/wikipedia/en/7/7c/Royal_Standard_de_Liege.svg",
  "Royal Charleroi SC":
    "https://upload.wikimedia.org/wikipedia/en/e/e1/Royal_Charleroi_Sporting_Club_logo.svg",
  "KAA Gent":
    "https://upload.wikimedia.org/wikipedia/en/f/f4/KAA_Gent_logo.svg",
  "KV Kortrijk":
    "https://upload.wikimedia.org/wikipedia/en/1/17/KV_Kortrijk_logo_2016.svg",
  "Cercle Brugge":
    "https://upload.wikimedia.org/wikipedia/en/7/7c/Cercle_Brugge_KSV_logo.svg",
  "KV Oostende":
    "https://upload.wikimedia.org/wikipedia/en/e/e3/K.V._Oostende_logo.svg",
  "KAS Eupen":
    "https://upload.wikimedia.org/wikipedia/en/d/d3/Kas_Eupen_Logo.svg",
  "SV Zulte Waregem":
    "https://upload.wikimedia.org/wikipedia/en/6/67/Zulte-Waregem_logo.svg",
  "Royal Excel Mouscron":
    "https://upload.wikimedia.org/wikipedia/en/4/4e/Royal_Excel_Mouscron_logo.png",
  "Waasland-Beveren":
    "https://upload.wikimedia.org/wikipedia/en/b/bb/Waasland-Beveren_logo.svg",
  "Sporting Lokeren":
    "https://upload.wikimedia.org/wikipedia/en/c/c9/K.S.C._Lokeren_Oost-Vlaanderen_logo.svg",
  ...
  "Olympiacos Piraeus":
    "https://upload.wikimedia.org/wikipedia/en/f/f1/Olympiacos_FC_logo.svg",
  "Atromitos Athinon":
    "https://upload.wikimedia.org/wikipedia/en/e/e9/Atromitos.png",
  "AEK Athens":
    "https://upload.wikimedia.org/wikipedia/en/0/04/AEK_Athens_FC_logo.svg",
  "Panathinaikos Athens":
    "https://upload.wikimedia.org/wikipedia/en/5/5b/Panathinaikos-football-seal.png",
  "Aris Thessaloniki":
    "https://upload.wikimedia.org/wikipedia/en/e/e4/Aris_Thessaloniki_F.C._logo.svg",
  "AO Xanthi FC":
    "https://upload.wikimedia.org/wikipedia/en/1/1a/Xanthi_football_club.png",
  "Panionios Athens":
    "https://upload.wikimedia.org/wikipedia/en/7/70/Panionios_FC.png",
  "Asteras Tripolis":
    "https://upload.wikimedia.org/wikipedia/commons/6/67/Asteras_Tripolis.svg",
  Panaitolikos:
    "https://upload.wikimedia.org/wikipedia/en/f/f2/Panetolikos_new_emblem.png",
  "AE Larissa FC":
    "https://upload.wikimedia.org/wikipedia/en/2/25/Athlitiki_Enosi_Larissa_F.C._logo.svg",
  "Lamia 1964":
  ...
  "FK Zenit Saint Petersburg":
    "https://upload.wikimedia.org/wikipedia/commons/9/96/FC_Zenit_1_star_2015_logo.svg",
  "FC Krasnodar":
    "https://upload.wikimedia.org/wikipedia/en/3/30/FC_Krasnodar_logo.svg",
  "CSKA Moscow":
    "https://upload.wikimedia.org/wikipedia/en/2/26/PFK_CSKA_Logo.svg",
  "FK Spartak Moscow":
    "https://upload.wikimedia.org/wikipedia/en/9/93/FC_Spartak_Moscow_crest.svg",
  "FK Lokomotiv Moscow":
    "https://upload.wikimedia.org/wikipedia/en/9/93/FC_Lokomotiv_Moscow_logo.svg",
  "FC Rostov":
    "https://upload.wikimedia.org/wikipedia/en/a/a2/FC_Rostov_logo.svg",
  "FC Orenburg":
    "https://upload.wikimedia.org/wikipedia/en/2/2a/FC_Orenburg.png",
  "FK Ural Yekaterinburg":
    "https://upload.wikimedia.org/wikipedia/en/8/8f/FC_Ural_Yekaterinburg_logo.svg",
  "FK Rubin Kazan":
    "https://upload.wikimedia.org/wikipedia/en/3/32/FC_Rubin_Kazan_logo.svg",
  "PFK Arsenal Tula":
    "https://upload.wikimedia.org/wikipedia/en/5/5c/FC_Arsenal_Tula_logo.svg",
  "RFK Akhmat Grozny":
    "https://upload.wikimedia.org/wikipedia/en/3/36/Akhmat_Grozny_logo.png",
  "FC Krylia Sovetov Samara":
    "https://upload.wikimedia.org/wikipedia/en/9/9f/FC_Krylia_Sovetov_Samara_logo.png",
  "FK Dinamo Moscow":
    "https://upload.wikimedia.org/wikipedia/en/e/e7/Dynamo_Moscow_logo.svg",
  "FK Ufa":
    "https://upload.wikimedia.org/wikipedia/commons/1/1d/FC_Ufa_logo.svg",
  "FC Anzhi Makhachkala":
    "https://upload.wikimedia.org/wikipedia/en/3/36/FC_Anzhi_Makhachkala_logo.svg",
  "FK Yenisey Krasnoyarsk":
    "https://upload.wikimedia.org/wikipedia/en/4/44/Logo_yenisey.jpg",
  "FK Tambov":
    "https://upload.wikimedia.org/wikipedia/en/8/88/FC_Tambov_logo_2020.svg",
  "PFK Sochi":
    "https://upload.wikimedia.org/wikipedia/en/7/70/PFC_Sochi_logo.svg",
  "FK Khimki":
    "https://upload.wikimedia.org/wikipedia/en/3/3b/Fckhimkiforwiki.png",
  "SK Rotor Volgograd":
    "https://upload.wikimedia.org/wikipedia/en/6/6c/FC_Rotor_Volgograd_logo.png",
  "FC Shakhtar Donetsk":
    "https://upload.wikimedia.org/wikipedia/en/a/a1/FC_Shakhtar_Donetsk.svg",
  "FC Dynamo Kiev":
    "https://upload.wikimedia.org/wikipedia/commons/d/df/FC_Dynamo_Kyiv_logo.svg",
  "FC Oleksandriya":
    "https://upload.wikimedia.org/wikipedia/en/7/7e/FC_Oleksandriya_logo.svg",
  "FC Zorya Lugansk":
    "https://upload.wikimedia.org/wikipedia/en/3/37/FC_Zorya_Luhansk_logo.svg",
  "FC Vorskla Poltava":
    "https://upload.wikimedia.org/wikipedia/en/b/bd/FC_Vorskla_Poltava_logo.svg",
  "FC Mariupol":
    "https://upload.wikimedia.org/wikipedia/en/7/79/FC_Mariupol_logo.svg",
  "FC Desna Chernihiv":
    "https://upload.wikimedia.org/wikipedia/commons/8/8b/FC_Desna.png",
  "FC Lviv": "https://upload.wikimedia.org/wikipedia/en/4/44/Fc_Lviv_logo.svg",
  "FC Olimpik Donetsk":
    "https://upload.wikimedia.org/wikipedia/en/5/5c/Olimpik_Donetsk.jpg",
  "Karpaty Lviv":
    "https://upload.wikimedia.org/wikipedia/en/a/a3/FC_Karpaty_Lviv.svg",
  "FC Chernomorets Odessa":
    "https://upload.wikimedia.org/wikipedia/en/7/77/Chornomorets_odesa_logo_uk.jpg",
  "FC Arsenal Kiev":
    "https://upload.wikimedia.org/wikipedia/en/f/f8/FC_Arsenal-Kyiv_logo.png",
  "Kolos Kovalivka":
  ...
  "SC Braga":
    "https://upload.wikimedia.org/wikipedia/en/7/79/S.C._Braga_logo.svg",
  "SL Benfica":
  ...
  "Vitoria Guimarares":
    "https://upload.wikimedia.org/wikipedia/en/d/d5/Vit%C3%B3ria_Guimar%C3%A3es.svg",
  "Rio Ave FC":
    "https://upload.wikimedia.org/wikipedia/en/0/0c/Rio_Ave_FC_logo.svg",
  "Belenenses SAD":
    "https://upload.wikimedia.org/wikipedia/en/4/42/Belenenses_SAD_logo.svg",
  "Vitoria Setubal":
    "https://upload.wikimedia.org/wikipedia/en/0/0b/Vit%C3%B3ria_F.C._logo.svg",
  "Moreirense FC":
    "https://upload.wikimedia.org/wikipedia/en/1/1b/Moreirense_Futebol_Clube_logo.svg",
  "CD Santa Clara":
  ...
  "CS Maritimo Madeira":
    "https://upload.wikimedia.org/wikipedia/en/e/e4/Club_Sport_Mar%C3%ADtimo_logo.svg",
  "CD Tondela":
    "https://upload.wikimedia.org/wikipedia/en/0/00/C.D._Tondela.png",
  "Boavista FC":
    "https://upload.wikimedia.org/wikipedia/en/4/40/Boavista_F.C._logo.svg",
  "CD Feirense":
  ...
  "FC Famalicao":
    "https://upload.wikimedia.org/wikipedia/en/0/0e/F.C._Famalic%C3%A3o_logo.svg",
  "Gil Vicente FC":
